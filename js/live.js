/* Live translations: NASB (api.bible) and ESV (api.esv.org), both fetched per chapter through the
   Cloudflare Worker, which holds the API keys server-side. Book arguments are native book codes. */
